 ...
 */
@WebServlet(name="InvalidInputGetCalendarServlet", urlPatterns = {"/invalidinputgetcalendar"})
public class InvalidInputGetCalendarServlet extends HttpServlet{
    @Override
    ...
    private void computeResponse(HttpServletRequest request, HttpServletResponse response) throws IOException {
        ...
        ResponseGetCalendar rgc = new ResponseGetCalendar(ResponseGetCalendarType.GET_CALENDAR_WRONG_INPUT, null);
