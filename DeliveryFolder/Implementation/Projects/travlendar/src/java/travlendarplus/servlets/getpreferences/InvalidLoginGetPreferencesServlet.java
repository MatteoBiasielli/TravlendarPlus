 ...
 * @author Emilio
 */
@WebServlet(name = "InvalidLoginGetPreferencesServlet", urlPatterns = {"/invalidlogingetpreferences"})
public class InvalidLoginGetPreferencesServlet extends HttpServlet {
    ...
    protected void computeResponse(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        ResponseGetPreferences rr= new ResponseGetPreferences(ResponseGetPreferencesType.GET_PREFERENCES_INVALID_LOGIN);
