 ...
 * @author Emilio
 */
@WebServlet(name = "InvalidLoginUpdateBooleanPreferencesServlet", urlPatterns = {"/invalidloginupdatebooleanpreferences"})
public class InvalidLoginUpdateBooleanPreferencesServlet extends HttpServlet {
    ...
    protected void computeResponse(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        ResponseUpdateBooleanPreferences rr= new ResponseUpdateBooleanPreferences(ResponseUpdateBooleanPreferencesType.UPDATE_BOOLEAN_PREFERENCES_INVALID_LOGIN);
