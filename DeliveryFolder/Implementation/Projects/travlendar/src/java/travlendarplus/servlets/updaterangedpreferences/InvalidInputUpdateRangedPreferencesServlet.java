 ...
 * @author Emilio
 */
@WebServlet(name = "InvalidInputUpdateRangedPreferencesServlet", urlPatterns = {"/invalidinputupdaterangedpreferences"})
public class InvalidInputUpdateRangedPreferencesServlet extends HttpServlet {
    ...
    protected void computeResponse(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        ResponseUpdateRangedPreferences rr= new ResponseUpdateRangedPreferences(ResponseUpdateRangedPreferencesType.UPDATE_RANGED_PREFERENCES_WRONG_INPUT);
