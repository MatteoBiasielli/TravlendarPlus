 ...
 * @author matteo
 */
@WebServlet(name = "AlreadyExistingTagAddTagServlet", urlPatterns = {"/tagexistsaddtag"})
public class AlreadyExistingTagAddTagServlet extends HttpServlet{
    @Override
    ...
    private void computeResponse(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException{
        ...
        ResponseAddTag rat= new ResponseAddTag(ResponseAddTagType.ADD_TAG_ALREADY_EXISTING,null);
