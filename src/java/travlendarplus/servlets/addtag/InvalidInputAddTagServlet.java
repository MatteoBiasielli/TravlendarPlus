 ...
 * @author matteo
 */
@WebServlet(name = "InvalidInputAddTagServlet", urlPatterns = {"/invalidinputaddtag"})
public class InvalidInputAddTagServlet extends HttpServlet{
    @Override
    ...
    private void computeResponse(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException{
        ...
        ResponseAddTag rat= new ResponseAddTag(ResponseAddTagType.ADD_TAG_WRONG_INPUT,null);
