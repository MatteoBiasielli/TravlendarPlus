 ...
 * @author Emilio
 */
@WebServlet(name = "ConnectionErrorDeleteRangedPreferencesServlet", urlPatterns = {"/connectionerrordeleterangedpreferences"})
public class ConnectionErrorDeleteRangedPreferencesServlet extends HttpServlet {
    ...
    protected void computeResponse(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        ResponseDeleteRangedPreferences rr= new ResponseDeleteRangedPreferences(ResponseDeleteRangedPreferencesType.DELETE_RANGED_PREFERENCES_CONNECTION_ERROR);
