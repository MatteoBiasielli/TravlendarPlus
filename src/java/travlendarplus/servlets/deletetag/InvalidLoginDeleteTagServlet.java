 ...
 * @author matteo
 */
@WebServlet(name = "InvalidLoginDeleteTagServlet", urlPatterns = {"/invalidlogindeletetag"})
public class InvalidLoginDeleteTagServlet extends HttpServlet{
    @Override
    ...
    private void computeResponse(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException{
        ...
        ResponseDeleteTag rdt= new ResponseDeleteTag(ResponseDeleteTagType.DELETE_TAG_LOGIN_ERROR,null);
