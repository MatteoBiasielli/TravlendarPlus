 ...
 * @author matteo
 */
@WebServlet(name = "ConectionProblemLogin", urlPatterns = {"/connectionerrorlogin"})
public class ConectionProblemLogin extends HttpServlet {
    ...
    private void computeResponse(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException{
        ...
        ResponseLogin rl= new ResponseLogin(ResponseLoginType.LOGIN_CONNECTION_ERROR,null);
