 ...
 * @author matteo
 */
@WebServlet(name = "AlreadyExistingUserRegisterServlet", urlPatterns = {"/registerusernameexists"})
public class AlreadyExistingUserRegisterServlet extends HttpServlet {
    ...
    private void computeResponse(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException{
        ...
        ResponseRegister rr= new ResponseRegister(ResponseRegisterType.REGISTER_USERNAME_ERROR);
