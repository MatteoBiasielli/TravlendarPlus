 ...
 * @author matteo
 */
@WebServlet(name = "ConnectionErrorRegisterServlet", urlPatterns = {"/connectionerrorregister"})
public class ConnectionErrorRegisterServlet extends HttpServlet {
    ...
    private void computeResponse(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException{
        ...
        ResponseRegister rr= new ResponseRegister(ResponseRegisterType.REGISTER_CONNECTION_ERROR);
