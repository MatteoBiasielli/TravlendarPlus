 ...
 * @author matteo
 */
@WebServlet(name = "InvalidInputTravelServlet", urlPatterns = {"/invalidinputtravel"})
public class InvalidInputTravelServlet extends HttpServlet{
    @Override
    ...
    private void computeResponse(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException{
        ...
        ResponseTravel rt= new ResponseTravel(null, ResponseTravelType.TRAVEL_WRONG_INPUT);
