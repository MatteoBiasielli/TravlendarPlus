 ...
 * @author matteo
 */
@WebServlet(name = "InvalidLoginTravelServlet", urlPatterns = {"/invalidlogintravel"})
public class InvalidLoginTravelServlet extends HttpServlet{
    @Override
    ...
    private void computeResponse(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException{
        ...
        ResponseTravel rt= new ResponseTravel(null, ResponseTravelType.TRAVEL_LOGIN_ERROR);
