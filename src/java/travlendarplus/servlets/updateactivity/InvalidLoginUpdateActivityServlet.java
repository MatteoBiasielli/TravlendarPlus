 ...
 */
@WebServlet(name = "InvalidLoginUpdateActivityServlet", urlPatterns = {"/invalidloginupdateactivity"})
public class InvalidLoginUpdateActivityServlet extends HttpServlet {
    @Override
    ...
    private void computeResponse(HttpServletRequest request, HttpServletResponse response) throws IOException {
        ...
        ResponseUpdateActivity rua = new ResponseUpdateActivity(null, ResponseUpdateActivityType.UPDATE_ACTIVITY_LOGIN_ERROR, null);
