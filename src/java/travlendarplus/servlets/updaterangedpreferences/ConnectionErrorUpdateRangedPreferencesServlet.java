 ...
 * @author Emilio
 */
@WebServlet(name = "ConnectionErrorUpdateRangedPreferencesServlet", urlPatterns = {"/connectionerrorupdaterangedpreferences"})
public class ConnectionErrorUpdateRangedPreferencesServlet extends HttpServlet {
    ...
    protected void computeResponse(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        ResponseUpdateRangedPreferences rr= new ResponseUpdateRangedPreferences(ResponseUpdateRangedPreferencesType.UPDATE_RANGED_PREFERENCES_CONNECTION_ERROR);
