 ...
 * @author Emilio
 */
@WebServlet(name = "InvalidLoginUpdateRangedPreferencesServlet", urlPatterns = {"/invalidloginupdaterangedpreferences"})
public class InvalidLoginUpdateRangedPreferencesServlet extends HttpServlet {
    ...
    protected void computeResponse(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        ResponseUpdateRangedPreferences rr= new ResponseUpdateRangedPreferences(ResponseUpdateRangedPreferencesType.UPDATE_RANGED_PREFERENCES_INVALID_LOGIN);
