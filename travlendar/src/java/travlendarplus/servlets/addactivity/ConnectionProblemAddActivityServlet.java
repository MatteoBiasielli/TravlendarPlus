 ...
 * @author matteo
 */
@WebServlet(name = "ConnectionProblemAddActivityServlet", urlPatterns = {"/connectionproblemaddactivity"})
public class ConnectionProblemAddActivityServlet extends HttpServlet{
    @Override
    ...
    private void computeResponse(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException{
        ...
        ResponseAddActivity raa= new ResponseAddActivity(null,ResponseAddActivityType.ADD_ACTIVITY_CONNECTION_ERROR,null);
