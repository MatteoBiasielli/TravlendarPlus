 ...
 * @author matteo
 */
@WebServlet(name = "InvalidInputAddActivityServlet", urlPatterns = {"/invalidinputaddactivity"})
public class InvalidInputAddActivityServlet extends HttpServlet{
    @Override
    ...
    private void computeResponse(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException{
        ...
        ResponseAddActivity raa= new ResponseAddActivity(null,ResponseAddActivityType.ADD_ACTIVITY_WRONG_INPUT,null);
