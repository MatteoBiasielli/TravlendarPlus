 ...
 * @author matteo
 */
@WebServlet(name = "PastAddActivityServlet", urlPatterns = {"/pastaddactivity"})
public class PastAddActivityServlet extends HttpServlet{
    @Override
    ...
    private void computeResponse(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException{
        ...
        ResponseAddActivity raa= new ResponseAddActivity(null,ResponseAddActivityType.ADD_ACTIVITY_PAST,null);
