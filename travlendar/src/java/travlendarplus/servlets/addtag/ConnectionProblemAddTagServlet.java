 ...
 * @author matteo
 */
@WebServlet(name = "ConnectionProblemAddTagServlet", urlPatterns = {"/connectionerroraddtag"})
public class ConnectionProblemAddTagServlet extends HttpServlet{
    @Override
    ...
    private void computeResponse(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException{
        ...
        ResponseAddTag rat= new ResponseAddTag(ResponseAddTagType.ADD_TAG_CONNECTION_ERROR,null);
