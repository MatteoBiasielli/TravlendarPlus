 ...
 */
@WebServlet(name="ConnectionProblemDeleteActivityServlet", urlPatterns = {"/connectionerrordeleteactivity"} )
public class ConnectionProblemDeleteActivityServlet extends HttpServlet{
    @Override
    ...
    private void computeResponse(HttpServletRequest request, HttpServletResponse response) throws IOException {
        ...
        ResponseDeleteActivity rda = new ResponseDeleteActivity(ResponseDeleteActivityType.DELETE_ACTIVITY_CONN_ERROR, null);
