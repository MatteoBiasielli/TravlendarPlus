 ...
 */
@WebServlet(name="InvalidInputDeleteActivityServlet", urlPatterns = {"/invalidinputdeleteactivity"} )
public class InvalidInputDeleteActivityServlet extends HttpServlet{
    @Override
    ...
    private void computeResponse(HttpServletRequest request, HttpServletResponse response) throws IOException {
        ...
        ResponseDeleteActivity rda = new ResponseDeleteActivity(ResponseDeleteActivityType.DELETE_ACTIVITY_WRONG_INPUT, null);
