 ...
 * @author matteo
 */
@WebServlet(name = "InvalidInputDeleteTagServlet", urlPatterns = {"/invalidinputdeletetag"})
public class InvalidInputDeleteTagServlet extends HttpServlet{
    @Override
    ...
    private void computeResponse(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException{
        ...
        ResponseDeleteTag rdt= new ResponseDeleteTag(ResponseDeleteTagType.DELETE_TAG_WRONG_INPUT,null);
