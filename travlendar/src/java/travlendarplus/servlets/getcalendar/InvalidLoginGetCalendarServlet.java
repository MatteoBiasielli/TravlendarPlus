 ...
 */
@WebServlet(name="InvalidLoginGetCalendarServlet", urlPatterns = {"/invalidlogingetcalendar"})
public class InvalidLoginGetCalendarServlet extends HttpServlet {
    @Override
    ...
    private void computeResponse(HttpServletRequest request, HttpServletResponse response) throws IOException {
        ...
        ResponseGetCalendar rgc = new ResponseGetCalendar(ResponseGetCalendarType.GET_CALENDAR_LOGIN_ERROR, null);
