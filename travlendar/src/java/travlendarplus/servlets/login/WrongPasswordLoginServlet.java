 ...
 * @author matteo
 */
@WebServlet(name = "WrongPasswordLoginServlet", urlPatterns = {"/wrongpasswordlogin"})
public class WrongPasswordLoginServlet extends HttpServlet {
    ...
    private void computeResponse(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException{
        ...
        ResponseLogin rl= new ResponseLogin(ResponseLoginType.LOGIN_PASSWORD_ERROR,null);
