 ...
 * @author matteo
 */
@WebServlet(name = "ConnectionErrorTravelServlet", urlPatterns = {"/connectionerrortravel"})
public class ConnectionErrorTravelServlet extends HttpServlet{
    @Override
    ...
    private void computeResponse(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException{
        ...
        ResponseTravel rt= new ResponseTravel(null, ResponseTravelType.TRAVEL_CONN_ERROR);
