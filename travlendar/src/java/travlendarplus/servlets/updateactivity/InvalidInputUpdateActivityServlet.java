 ...
 */
@WebServlet(name = "InvalidInputUpdateActivityServlet", urlPatterns = {"/invalidinputupdateactivity"})
public class InvalidInputUpdateActivityServlet extends HttpServlet{
    @Override
    ...
    private void computeResponse(HttpServletRequest request, HttpServletResponse response) throws IOException {
        ...
        ResponseUpdateActivity rua = new ResponseUpdateActivity(null, ResponseUpdateActivityType.UPDATE_ACTIVITY_WRONG_INPUT, null);
