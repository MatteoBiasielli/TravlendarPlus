 ...
 */
@WebServlet(name = "PastInsertionUpdateActivityServlet", urlPatterns = {"/pastupdateactivity"})
public class PastInsertionUpdateActivityServlet extends HttpServlet{
    @Override
    ...
    private void computeResponse(HttpServletRequest request, HttpServletResponse response) throws IOException {
        ...
        ResponseUpdateActivity rua = new ResponseUpdateActivity(null, ResponseUpdateActivityType.UPDATE_ACTIVITY_PAST_INSERTION, null);
