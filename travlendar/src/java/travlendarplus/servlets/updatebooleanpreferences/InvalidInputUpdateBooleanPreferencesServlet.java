 ...
 * @author Emilio
 */
@WebServlet(name = "InvalidInputUpdateBooleanPreferencesServlet", urlPatterns = {"/invalidinputupdatebooleanpreferences"})
public class InvalidInputUpdateBooleanPreferencesServlet extends HttpServlet {
  ...
  /**
    ...
    protected void computeResponse(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        ResponseUpdateBooleanPreferences rr= new ResponseUpdateBooleanPreferences(ResponseUpdateBooleanPreferencesType.UPDATE_BOOLEAN_PREFERENCES_WRONG_INPUT);
